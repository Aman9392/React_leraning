  ...
  return (
    <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`}>
      <div className="container-fluid">
        <Link to="Aman" className="navbar-brand">{props.title}</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          {/* <div className={`form-check src form-switch  text-${props.mode === 'light' ? 'dark' : 'light'}`}>
            <input className="form-check-input"  onClick={() =>{ props.toggle('null') }} type="checkbox" id="flexSwitchCheckDefault" />
            <label className="form-check-label bot" htmlFor="flexSwitchCheckDefault">Change Theme</label>
          </div> */}
          <div className="d-flex src">
